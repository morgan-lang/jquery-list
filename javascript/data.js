    ...
    //hook onto the ul in artists_in_history
  ...
  function buildListItems(myObject)
      {
        ...
        for (i in myObject)
        {
          //remember that single quotes indicate literal strings. Keep track of literal string quotes and the double quotes used in things like href tags. Below we'll use our script to populate li, href, img, fullName, and years tags and elements: 
          output += '<li>';
          ...
          //don't forget that this whole thing creates content for each li item, so we have to close out our li tag:
          output += '</li>';
        } 
